...
const translations: Record<string, TranslationValue> = {
    ...
    // ============ Order Status Labels ============
    'status.pending': { th: 'รอชำระเงิน', en: 'Pending Payment', jp: '支払い待ち' },
    'status.verifying': { th: 'รอตรวจสอบ', en: 'Verifying', jp: '確認中' },
    'status.paid': { th: 'ชำระแล้ว', en: 'Paid', jp: '支払済み' },
    'status.shipped': { th: 'จัดส่งแล้ว', en: 'Shipped', jp: '発送済み' },
    'status.cancelled': { th: 'ยกเลิก', en: 'Cancelled', jp: 'キャンセル' },
    'status.completed': { th: 'สำเร็จ', en: 'Completed', jp: '完了' },
    'status.paymentFailed': { th: 'ชำระเงินไม่สำเร็จ', en: 'Payment Failed', jp: '支払い失敗' },
    ...
    // ============ Orders Page ============
    'orders.breadcrumbHome': { th: 'หน้าแรก', en: 'Home', jp: 'ホーム' },
    'orders.breadcrumbOrders': { th: 'คำสั่งซื้อของฉัน', en: 'My Orders', jp: 'マイオーダー' },
    'orders.title': { th: 'คำสั่งซื้อของฉัน', en: 'My Orders', jp: 'マイオーダー' },
    'orders.empty': { th: 'ยังไม่มีคำสั่งซื้อ', en: 'No orders yet', jp: 'まだ注文はありません' },
    ...
    'orderSuccess.subtitle': { th: 'เราได้รับคำสั่งซื้อของคุณแล้ว และจะดำเนินการจัดส่งโดยเร็วที่สุด', en: 'We have received your order and will process it as soon as possible.', jp: 'ご注文を受け付けました。できるだけ早く発送いたします。' },
    ...
    'orderSuccess.items': { th: 'รายการสินค้า', en: 'Items', jp: '商品一覧' },
