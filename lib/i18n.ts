...
const translations: Record<string, TranslationValue> = {
    ...
    // ============ Orders Page ============
    'orders.title': { th: 'คำสั่งซื้อของฉัน', en: 'My Orders', jp: '注文履歴' },
    'orders.empty': { th: 'ยังไม่มีคำสั่งซื้อ', en: 'No orders found', jp: '注文はありません' },
    'orders.orderId': { th: 'หมายเลขคำสั่งซื้อ', en: 'Order ID', jp: '注文ID' },
    'orders.date': { th: 'วันที่สั่งซื้อ', en: 'Order Date', jp: '注文日' },
    'orders.total': { th: 'ยอดรวม', en: 'Total Amount', jp: '合計金額' },
    'orders.status': { th: 'สถานะ', en: 'Status', jp: 'ステータス' },
    'orders.details': { th: 'ดูรายละเอียด', en: 'View Details', jp: '詳細を見る' },
    'orders.quantity': { th: 'จำนวน', en: 'Qty', jp: '数量' },
    'orders.pieces': { th: 'ชิ้น', en: 'pcs', jp: '個' },
    'orders.totalNet': { th: 'ยอดชำระสุทธิ', en: 'Net Total', jp: '支払い合計' },
    'orders.reuploadSlip': { th: 'อัปโหลดสลิปใหม่', en: 'Re-upload Slip', jp: 'スリップを再アップロード' },
    'orders.notifyPayment': { th: 'แจ้งชำระเงิน', en: 'Notify Payment', jp: '支払いを通知' },
    'orders.viewReceipt': { th: 'ดูใบเสร็จ', en: 'View Receipt', jp: '領収書を見る' },
    ...
    'orders.defaultRejection': { th: 'สลิปไม่ถูกต้อง หรือยอดเงินไม่ตรง', en: 'Invalid slip or incorrect amount', jp: 'スリップが無効か、金額が不正確です' },
    'orders.trackingNumber': { th: 'เลขพัสดุ', en: 'Tracking Number', jp: '追跡番号' },
    'orders.copyTracking': { th: 'คัดลอก', en: 'Copy', jp: 'コピー' },
    'orders.checkStatus': { th: 'เช็คสถานะ', en: 'Check Status', jp: 'ステータス確認' },
    'orders.paymentTitle': { th: 'ชำระเงินผ่าน QR Code', en: 'Scan QR to Pay', jp: 'QRコードで支払う' },
    'orders.scanQr': { th: 'สแกน QR Code เพื่อชำระเงิน', en: 'Scan QR Code to pay', jp: 'QRコードをスキャンして支払う' },
    'orders.bankInfo': { th: 'ธนาคารกสิกรไทย • บริษัท ไอแฮฟจีพียู จำกัด', en: 'KBank • iHAVEGPU Co., Ltd.', jp: 'カシコン銀行 • iHAVEGPU Co., Ltd.' },
    'orders.amountToPay': { th: 'ยอดที่ต้องชำระ', en: 'Amount to Pay', jp: '支払い金額' },
    ...
    'orders.supportsFile': { th: 'รองรับไฟล์ JPG, PNG', en: 'Supports JPG, PNG', jp: 'JPG, PNG 対応' },
    'orders.loadError': { th: 'โหลดข้อมูลไม่สำเร็จ', en: 'Failed to load orders', jp: '注文の読み込みに失敗しました' },
    'orders.copied': { th: 'คัดลอกเรียบร้อย', en: 'Copied!', jp: 'コピーしました！' },
    'orders.copyNotSupported': { th: 'เบราว์เซอร์ไม่รองรับการคัดลอก', en: 'Copy not supported', jp: 'コピーはサポートされていません' },
    'orders.uploadingSlip': { th: 'กำลังอัปโหลดสลิป...', en: 'Uploading slip...', jp: 'スリップをアップロード中...' },
    'orders.slipSuccess': { th: 'ส่งหลักฐานเรียบร้อย', en: 'Slip uploaded successfully', jp: 'スリップที่อัปโหลดแล้ว' },
    'orders.slipError': { th: 'อัปโหลดสลิปไม่สำเร็จ', en: 'Failed to upload slip', jp: 'สลิปอัปโหลดไม่สำเร็จ' },
    'orders.breadcrumbHome': { th: 'หน้าแรก', en: 'Home', jp: 'ホーム' },
    'orders.breadcrumbOrders': { th: 'รายการคำสั่งซื้อ', en: 'My Orders', jp: '注文履歴' },

    // ============ Product Detail ============
    'product.notFound': { th: 'ไม่พบสินค้า', en: 'Product not found', jp: '商品が見つかりません' },
    'product.backHome': { th: 'กลับไปหน้าแรก', en: 'Back to Home', jp: 'ホームに戻る' },
    'product.reviews': { th: 'รีวิว', en: 'Reviews', jp: 'レビュー' },
    'product.id': { th: 'รหัส', en: 'ID', jp: 'ID' },
    'product.inStock': { th: 'มีสินค้า', en: 'In Stock', jp: '在庫あり' },
    'product.outOfStock': { th: 'สินค้าหมด', en: 'Out of Stock', jp: '在庫切れ' },
    'product.readyToShip': { th: 'พร้อมจัดส่งภายใน 24 ชม.', en: 'Ready to ship in 24h', jp: '24時間以内に発送' },
    'product.warranty': { th: 'ประกันศูนย์ไทย', en: 'Official Warranty', jp: '正規保証' },
    'product.authentic': { th: 'ของแท้ 100%', en: 'Authentic 100%', jp: '100% 正規品' },
    'product.freeShipping': { th: 'ส่งฟรีทั่วไทย', en: 'Free Shipping', jp: '送料無料' },
    'product.fastDelivery': { th: 'ถึงไว 1-2 วัน', en: 'Fast Delivery 1-2 days', jp: '1-2日でお届け' },
    'product.returnPolicy': { th: 'เปลี่ยนคืน 30 วัน', en: '30 Days Return', jp: '30日間返品可能' },
    'product.claim': { th: 'มีปัญหาเคลมได้', en: 'Easy Claim', jp: '簡単に請求' },
    'product.safePacking': { th: 'แพ็คแน่นหนา', en: 'Safe Packing', jp: '安全な梱包' },
    'product.safePackingDesc': { th: 'ปลอดภัยทุกชิ้น', en: 'Safe for every piece', jp: 'すべての商品を安全に' },
    'product.details': { th: 'รายละเอียด', en: 'Details', jp: '詳細' },
    'product.specs': { th: 'สเปคสินค้า', en: 'Specifications', jp: '仕様' },
    'product.noSpecs': { th: 'ไม่ระบุข้อมูล', en: 'No specifications', jp: '仕様なし' },
    'product.customerReviews': { th: 'รีวิวลูกค้า', en: 'Customer Reviews', jp: 'カスタマーレビュー' },
    'product.noReviews': { th: 'ยังไม่มีรีวิว เป็นคนแรกที่รีวิวสินค้านี้เลย!', en: 'No reviews yet. Be the first to review!', jp: 'レビューはまだありません。最初のレビューを書きましょう！' },
    'product.related': { th: 'สินค้าที่คุณอาจสนใจ', en: 'You might also like', jp: 'あなたへのおすすめ' },
    // End of Product Detail keys
