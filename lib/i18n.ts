...
const translations: Record<string, TranslationValue> = {
    ...
    // ============ Orders (Combined and deduplicated) ============
    ...
    'orders.slipError': { th: 'อัปโหลดสลิปไม่สำเร็จ', en: 'Failed to upload slip', jp: 'スリップอัปโหลดไม่สำเร็จ' },
    ...
    // ============ Order Status Labels (Deduplicated) ============
