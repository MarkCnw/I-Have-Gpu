...
export default function Loading() {
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-sans pb-24 animate-pulse">
      {/* Breadcrumb Skeleton */}
      ...
      <div className="max-w-7xl mx-auto px-6 mt-8 md:mt-12">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 mb-20">
          ...
          <div className="space-y-4">
            <div className="aspect-square w-full bg-neutral-200 rounded-2xl" />
          ...
          <div className="flex flex-col space-y-6">
            <div>
              <div className="h-6 w-20 bg-neutral-200 rounded-full mb-4" />
              <div className="h-12 w-full bg-neutral-200 rounded-lg mb-4" />
              <div className="h-12 w-3/4 bg-neutral-200 rounded-lg mb-4" />
              <div className="h-4 w-40 bg-neutral-200 rounded mt-2" />
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
            <div className="space-y-4">
              ...
              <div className="h-40 w-full bg-neutral-100 rounded-2xl" />
            </div>
            <div className="space-y-4">
              <div className="h-8 w-40 bg-neutral-200 rounded" />
              <div className="h-60 w-full bg-neutral-100 rounded-2xl" />
            </div>
          </div>
        </div>
      </div>
