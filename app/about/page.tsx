...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-sans text-neutral-900 pb-24 selection:bg-yellow-500 selection:text-white">
      
      {/* ================= HERO SECTION ================= */}
      <div className="relative bg-white border-b border-neutral-200 overflow-hidden">
      ...
      {/* ================= OUR PROCESS ================= */}
      <div className="bg-neutral-50 py-24 mt-24 border-y border-neutral-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">The iHAVEGPU Standard</h2>
            <p className="text-neutral-500 max-w-2xl mx-auto">มาตรฐานการทำงานระดับมืออาชีพที่เรายึดถือในทุกขั้นตอน</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-xl border border-neutral-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
