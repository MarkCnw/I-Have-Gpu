        ...
        <section>
          <div className="flex items-end justify-between mb-8 border-b border-neutral-200 pb-4">
             <div>
                ...
                <p className="text-sm text-neutral-500 mt-1">ครอบคลุมสินค้าทุกหมวดหมู่ด้วยมาตรฐานสูงสุด</p>
             </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {WARRANTY_PERIODS.map((item, index) => (
              <div key={index} className="bg-white border border-neutral-200 p-6 rounded-xl hover:shadow-md transition-shadow group">
                <div className="flex items-center justify-between mb-4">
                  <div className="p-2.5 bg-neutral-50 rounded-lg text-neutral-600 group-hover:bg-black group-hover:text-white transition-colors">
                    <item.icon size={20} strokeWidth={1.5} />
                  </div>
                  <span className="text-sm font-bold text-neutral-900 bg-neutral-100 px-3 py-1 rounded-md">
                    {item.period}
                  </span>
                </div>
                <h3 className="text-base font-semibold text-neutral-700">{item.category}</h3>
                <p className="text-xs text-neutral-400 mt-1">Full Coverage Warranty</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="relative">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={i} className="bg-white border border-neutral-200 p-6 rounded-xl flex flex-col items-center text-center shadow-sm">
